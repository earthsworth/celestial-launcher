...
class GuiAddonManager : JPanel() {
    ...
    private fun initGui() {
        ...
        val openAgentConfigUi = JMenuItem(t.getString("gui.addon.extra-ui"))
        ...
        manageArg.addActionListener {
            ...
            if (newArg != null && currentAgent.arg != newArg) {
                ...
                if (newArg.isBlank()) {
                    ...
                    t.format(
                        "gui.addon.agents.arg.set.success", currentAgent.file.name, newArg
                    ).updateStatusText()
                }
                agentList.clear()
                loadAgents()
        ...
        removeAgent.addActionListener {
            ...
            if (JOptionPane.showConfirmDialog(
                ...
                t.format("gui.addon.agents.remove.success", name).updateStatusText()
                agentList.clear()
                loadAgents()
            }
        }
        ...
        renameAgent.addActionListener {
            ...
            val newName = JOptionPane.showInputDialog(
                this, t.getString("gui.addon.rename.dialog.message"), name.substring(0, name.length - 4)
            )
            if (newName != null && file.renameTo(File(file.parentFile, "$newName.jar"))) {
                log.info("Rename agent $name -> $newName.jar")
                t.format("gui.addon.rename.success", newName).updateStatusText()
        ...
        openAgentConfigUi.addActionListener {
            val currentAgent = jListAgents.selectedValue
            if (currentAgent.hasExtraUi) {
                currentAgent.openConfigWindow()
            } else {
                JOptionPane.showMessageDialog(
                    this,
                    t.getString("gui.addon.extra-ui.unavailable.description"),
                    t.getString("gui.addon.extra-ui.unavailable.title"),
        ...
        renameLunarCNMod.addActionListener {
            ...
            if (newName != null && file.renameTo(File(file.parentFile, "$newName.jar"))) {
                ...
                String.format(t.getString("gui.addon.rename.success"), newName).updateStatusText()
                lunarcnList.clear()
                loadLunarCNMods()
            }
        }
        ...
        removeLunarCNMod.addActionListener {
            ...
            if (JOptionPane.showConfirmDialog(
                ...
                t.format("gui.addon.mods.cn.remove.success", name).updateStatusText()
                lunarcnList.clear()
                loadLunarCNMods()
            }
        }
        ...
        removeFabricMod.addActionListener {
            ...
            if (JOptionPane.showConfirmDialog(
                ...
                t.format("gui.addon.mods.fabric.remove.success", name).updateStatusText()
                fabricList.clear()
                loadFabricMods()
            }
        }
        ...
        btnAddAgent.addActionListener {
            ...
            try {
                ...
                if (agent != null) {
                    ...
                    t.getString("gui.addon.agents.add.success").updateStatusText()
                    agentList.clear()
                    loadAgents()
                } else {
                    JOptionPane.showMessageDialog(
                        this, t.getString("gui.addon.agents.add.failure.exists"), "Error", JOptionPane.ERROR_MESSAGE
                    )
                }
            } catch (e: IOException) {
                ...
                log.error(trace)
                JOptionPane.showMessageDialog(
                    this, t.format("gui.addon.agents.add.failure.io", trace), "Error", JOptionPane.ERROR_MESSAGE
                )
            }
        }
        ...
        btnAddWeaveMod.addActionListener {
            ...
            try {
                ...
                if (mod != null) {
                    ...
                    t.getString("gui.addon.mods.weave.add.success").updateStatusText()
                    weaveList.clear()
                    loadWeaveMods()
                } else {
                    JOptionPane.showMessageDialog(
                        this, t.getString("gui.addon.mods.weave.add.failure.exists"), "Error", JOptionPane.ERROR_MESSAGE
                    )
                }
            } catch (e: IOException) {
                val trace = e.stackTraceToString()
                log.error(trace)
                JOptionPane.showMessageDialog(
                    this, t.format("gui.addon.mods.weave.add.failure.io", trace), "Error", JOptionPane.ERROR_MESSAGE
                )
            }
        }
        ...
        btnAddLunarCNMod.addActionListener {
            ...
            try {
                ...
                if (mod != null) {
                    ...
                    t.getString("gui.addon.mods.cn.add.success").updateStatusText()
                    weaveList.clear()
                    loadWeaveMods()
                } else {
                    JOptionPane.showMessageDialog(
                        this, t.getString("gui.addon.mods.cn.add.failure.exists"), "Error", JOptionPane.ERROR_MESSAGE
                    )
                }
            } catch (e: IOException) {
                val trace = e.stackTraceToString()
                log.error(trace)
                JOptionPane.showMessageDialog(
                    this, t.format("gui.addon.mods.cn.add.failure.io", trace), "Error", JOptionPane.ERROR_MESSAGE
                )
            }
        }
        ...
        btnAddFabric.addActionListener {
            ...
            try {
                ...
                if (mod != null) {
                    ...
                    t.getString("gui.addon.mods.fabric.add.success").updateStatusText()
                    fabricList.clear()
                    loadFabricMods()
                } else {
                    JOptionPane.showMessageDialog(
                ...
                log.error(trace)
                JOptionPane.showMessageDialog(
                    this, t.format("gui.addon.mods.fabric.add.failure.io", trace), "Error", JOptionPane.ERROR_MESSAGE
                )
            }
        }
